<?php
   ...
   $mail ->Subject = 'Thank you ' . $mailname . ' for your contact';
   $mail ->Body = 'We are very welcome any feedback from our dear customer. Bellow is your feedback, we have recieved it and very appreciated it: ' . $mailMsg;
...
<body data-target="#nino-navbar" data-spy="scroll" onload="checkCookies()">
  ...
  <div class="container">
    ...
    <h2 class="nino-sectionHeading">Thank you for your contact. The email have been send to your email adress </span>
    </h2>
