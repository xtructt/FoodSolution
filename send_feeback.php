<?php
    ...
    $mailMsg = $_POST['x-star-rating'];
    $mailMsg1 = $_POST['x-star-rating'];
    //feedback content
   ...
   $mail ->Subject = 'Thank you for your contact' . $mailSub;
   $mail ->Body = 'You have rated us' . $mailMsg1 . ' stars. We are very welcome any feedback from our dear customer. Bellow is your feedback, we have recieved it and very appreciated it:' . $mailMsg;
...
<body data-target="#nino-navbar" data-spy="scroll" onload="checkCookies()">
  ...
  <div class="container">
    ...
    <h2 class="nino-sectionHeading">
      <span class="nino-subHeading">Opps! somethings wrong happens, Please resend your feedback. It is our honour </span>
    </h2>
...
<body data-target="#nino-navbar" data-spy="scroll" onload="checkCookies()">
  ...
  <div class="container">
    <div class="row box">
    <h2 class="nino-sectionHeading">
      <span class="nino-subHeading">Thank you for your feedback!! We are very appreciated it </span>
    </h2>
